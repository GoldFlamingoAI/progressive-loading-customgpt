...
Use `MANUAL_PHASES.md` as the one complete step-by-step build document.
...
Read `docs/ARCHITECTURE.md` for the full system, data model, API contract, and acceptance criteria.
Use `apps-script/README.md` when copying the separate GAS files into Apps Script.
